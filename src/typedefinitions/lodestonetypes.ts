...
enum ClassJob {
    // TANK
    GLADIATOR,MARAUDER,PALADIN, WARRIOR, DARK_KNIGHT, GUNBREAKER,
    TANK_GLADIATOR,TANK_MARAUDER,TANK_PALADIN, TANK_WARRIOR, TANK_DARK_KNIGHT, TANK_GUNBREAKER,

    // HEALER
    CONJURER,WHITE_MAGE, SCHOLAR, ASTROLOGIAN, SAGE,
    HEALER_CONJURER,HEALER_WHITE_MAGE, HEALER_SCHOLAR, HEALER_ASTROLOGIAN, HEALER_SAGE,

    // MELEE_DPS
    LANCER,PUGILIST,ROUGE,ARCHER,MONK, DRAGOON, NINJA, SAMURAI, REAPER, VIPER,
    MELEE_DPS_LANCER,MELEE_DPS_PUGILIST,MELEE_DPS_ROUGE,MELEE_DPS_ARCHER,MELEE_DPS_MONK, MELEE_DPS_DRAGOON, MELEE_DPS_NINJA, MELEE_DPS_SAMURAI, MELEE_DPS_REAPER, MELEE_DPS_VIPER,
    ...
    // MAGICAL_RANGED_DPS
    ARCANIST,THAUMATURGE,BLACK_MAGE, SUMMONER, RED_MAGE, PICTOMANCER, BLUE_MAGE,
    MAGICAL_RANGED_DPS_ARCANIST,MAGICAL_RANGED_DPS_THAUMATURGE,MAGICAL_RANGED_DPS_BLACK_MAGE, MAGICAL_RANGED_DPS_SUMMONER, MAGICAL_RANGED_DPS_RED_MAGE, MAGICAL_RANGED_DPS_PICTOMANCER, MAGICAL_RANGED_DPS_BLUE_MAGE,
