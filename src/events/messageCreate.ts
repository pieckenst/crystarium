...
import { Interaction, CommandInteraction, ComponentInteraction, EmbedOptions, Message, PossiblyUncachedTextableChannel } from 'eris';
...
export default class extends defineEvent({
  ...
  description: 'Emitted when a message is created',
    ...
    static async execute(harmonix: Harmonix, msg: Message<PossiblyUncachedTextableChannel>) {
