...
import {
  ...
  logError,
  logDebug,
} from "../code-utils/centralloggingfactory";

function getJobNameFromIcon(iconUrl: string): string {
  const jobIconMapping: Record<string, string> = {
    "https://img.finalfantasyxiv.com/lds/h/U/F5JzG9RPIKFSogtaKNBk455aYA.png":
      "Gladiator",
    "https://img.finalfantasyxiv.com/lds/h/E/d0Tx-vhnsMYfYpGe9MvslemEfg.png":
      "Paladin",
    "https://img.finalfantasyxiv.com/lds/h/y/A3UhbjZvDeN3tf_6nJ85VP0RY0.png":
      "Warrior",
    "https://img.finalfantasyxiv.com/lds/h/N/St9rjDJB3xNKGYg-vwooZ4j6CM.png":
      "Marauder",
    "https://img.finalfantasyxiv.com/lds/h/l/5CZEvDOMYMyVn2td9LZigsgw9s.png":
      "Dark Knight",
    "https://img.finalfantasyxiv.com/lds/h/8/hg8ofSSOKzqng290No55trV4mI.png":
      "Gunbreaker",
    "https://img.finalfantasyxiv.com/lds/h/V/iW7IBKQ7oglB9jmbn6LwdZXkWw.png":
      "Pugilist",
    "https://img.finalfantasyxiv.com/lds/h/K/HW6tKOg4SOJbL8Z20GnsAWNjjM.png":
      "Monk",
    "https://img.finalfantasyxiv.com/lds/h/k/tYTpoSwFLuGYGDJMff8GEFuDQs.png":
      "Lancer",
    "https://img.finalfantasyxiv.com/lds/h/m/gX4OgBIHw68UcMU79P7LYCpldA.png":
      "Dragoon",
    "https://img.finalfantasyxiv.com/lds/h/y/wdwVVcptybfgSruoh8R344y_GA.png":
      "Rogue",
    "https://img.finalfantasyxiv.com/lds/h/0/Fso5hanZVEEAaZ7OGWJsXpf3jw.png":
      "Ninja",
    "https://img.finalfantasyxiv.com/lds/h/m/KndG72XtCFwaq1I1iqwcmO_0zc.png":
      "Samurai",
    "https://img.finalfantasyxiv.com/lds/h/s/gl62VOTBJrm7D_BmAZITngUEM8.png":
      "Conjurer",
    "https://img.finalfantasyxiv.com/lds/h/7/i20QvSPcSQTybykLZDbQCgPwMw.png":
      "White Mage",
    "https://img.finalfantasyxiv.com/lds/h/7/WdFey0jyHn9Nnt1Qnm-J3yTg5s.png":
      "Scholar",
    "https://img.finalfantasyxiv.com/lds/h/1/erCgjnMSiab4LiHpWxVc-tXAqk.png":
      "Astrologian",
    "https://img.finalfantasyxiv.com/lds/h/Q/ZpqEJWYHj9SvHGuV9cIyRNnIkk.png":
      "Archer",
    "https://img.finalfantasyxiv.com/lds/h/F/KWI-9P3RX_Ojjn_mwCS2N0-3TI.png":
      "Bard",
    "https://img.finalfantasyxiv.com/lds/h/E/vmtbIlf6Uv8rVp2YFCWA25X0dc.png":
      "Machinist",
    "https://img.finalfantasyxiv.com/lds/h/t/HK0jQ1y7YV9qm30cxGOVev6Cck.png":
      "Dancer",
    "https://img.finalfantasyxiv.com/lds/h/4/IM3PoP6p06GqEyReygdhZNh7fU.png":
      "Thaumaturge",
    "https://img.finalfantasyxiv.com/lds/h/P/V01m8YRBYcIs5vgbRtpDiqltSE.png":
      "Black Mage",
    "https://img.finalfantasyxiv.com/lds/h/e/VYP1LKTDpt8uJVvUT7OKrXNL9E.png":
      "Arcanist",
    "https://img.finalfantasyxiv.com/lds/h/h/4ghjpyyuNelzw1Bl0sM_PBA_FE.png":
      "Summoner",
    "https://img.finalfantasyxiv.com/lds/h/q/s3MlLUKmRAHy0pH57PnFStHmIw.png":
      "Red Mage",
    "https://img.finalfantasyxiv.com/lds/h/p/jdV3RRKtWzgo226CC09vjen5sk.png":
      "Blue Mage",
...
function parseRaceAndClan($: cheerio.CheerioAPI): { race: Race; clan: Clan } {
  ...
  switch (raceStr?.trim().toLowerCase()) {
    ...
    case "elezen":
      race = Race.Elezen;
      clan =
        clanStr.toLowerCase() === "wildwood" ? Clan.Wildwood : Clan.Duskwight;
      break;
    case "lalafell":
      race = Race.Lalafell;
      clan =
        clanStr.toLowerCase() === "plainsfolk"
          ? Clan.Plainsfolk
          : Clan.Dunesfolk;
      break;
    case "miqo'te":
      race = Race.Miqote;
      clan =
        clanStr.toLowerCase() === "seeker of the sun"
          ? Clan.SeekerOfTheSun
    ...
    case "roegadyn":
      race = Race.Roegadyn;
      clan =
        clanStr.toLowerCase() === "sea wolf" ? Clan.SeaWolf : Clan.Hellsguard;
      break;
    case "au ra":
      race = Race.AuRa;
...
> {
  ...
  if (bozjaElement.length) {
    ...
    if (bozjaExp) {
      ...
      logInfo(
        `  Bozjan Southern Front - Resistance Rank: ${bozjaLevel}, Mettle: ${bozjaExp[1]}/${bozjaExp[2]}`,
        "lodestone-utils",
      );
    }
  }
  ...
  if (eurekaElement.length) {
    ...
    logInfo(
      `  Eureka - Elemental Level: ${eurekaLevel}, Exp: ${eurekaExp[0]}/${eurekaExp[1]}`,
      "lodestone-utils",
    );
  }
...
function parseCharacterDetails($: cheerio.CheerioAPI) {
  ...
  const gender = $(".character-block__name")
    .first()
    .text()
    .trim()
    .split(" / ")[2];
